...
Return JSON:
{
  "impulses": [
    {
      "id": 1,
      "impulse": "short Chinese phrase describing the impulse",
...
CRITICAL RULES:
- "impulse" field: write in Chinese. MUST be at least 10 Chinese characters. Be specific and vivid, not generic.
  - GOOD: "第一次买怕选错浪费钱", "怕被室友听到声音很尴尬", "买了之后发现不如想象中好"
  - BAD: "好奇", "焦虑", "价格敏感", "幽默感", "文化影响" (too short, too generic)
